...
class RRT:
    ...
    def __init__(self, start, goal, obstacle_list, rand_area, max_expansion=0.015, path_resolution=0.5, goal_sample_rate=5, max_iter=10000, workspace_bounds=None, robot_radius=0.035):
...
def rrt_main(goal_pos, octree):
    ...
    rrt = RRT(start=start_pos, goal=goal_pos, rand_area=[-1, 1], obstacle_list=octree, workspace_bounds=workspace_bounds, robot_radius=0.06)
...
if __name__ == '__main__':
    ...
    rrt, path, pose_list = rrt_main(goal_pos, octree)
