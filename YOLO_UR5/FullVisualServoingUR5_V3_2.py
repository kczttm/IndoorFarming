# FINAL VERSION FROM SUMMER 2022 GRIP INTERNSHIP
...
# Testing YOLO
boxes = yolo_detection("testBerries.jpg", YOLO_WEIGHT_FILE)
frame = cv2.imread("testBerries.jpg")
# for line in boxes:
#   cv2.rectangle(frame, (int(line[0]),int(line[1])), (int(line[2]),int(line[3])), (0,255,0), 3)
# cv2.imwrite("new_testBerries.jpg",frame)
